...
_STATEFIELDREGISTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='imu_linear_acc', full_name='StateFieldRegistry.imu_linear_acc', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='imu_acc', full_name='StateFieldRegistry.imu_acc', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='imu_gyr_acc', full_name='StateFieldRegistry.imu_gyr_acc', index=21,
